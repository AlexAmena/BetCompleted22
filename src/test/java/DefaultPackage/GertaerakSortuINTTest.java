...
public class GertaerakSortuINTTest {
	...
	public void test1() {
		try {
			...
			ev = testBL.addEventWithQuestion(eventText,oneDate,queryText,betMinimum,lokal,kanpokoa );
	...
	public void test2() {
		try {
			...
			//configure the state of the system (create object in the dabatase)
			ev = testBL.addEventWithQuestion(eventText,oneDate,"query2",betMinimum, lokal,kanpokoa );
